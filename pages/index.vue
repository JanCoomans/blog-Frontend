<template>
    <div>
        ...
        <div class="relative"><!-- Wave seperator -->
            <svg class="absolute -translate-y-full w-full sm:h-12 lg:h-18 min-h-9 fill-primary-900" preserveAspectRatio="none" viewBox="0 0 1920 72">
